...
test.describe('testing index.html', async () => {
  ...
  test.beforeEach(async ({ page }) =>
    await page.goto('http://127.0.0.1:5500/DAY13/webapp/public/index.html')
  );
  ...
  test.afterAll(() => console.log("After all testcase this block got executed"))

  test.afterEach(() => console.log("After each testcase this block got executed"))
